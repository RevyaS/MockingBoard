class MainLayer
{
    constructor()
    {
        ...
        //Initial Page Size
        let page = new Page(0, 0, this.origWidth, this.origHeight, 0, this.layers.length);
        page.PanelName = "Panel";
    ...
    sliceVertically(mousePos)
    {
        ...
        let topPage = new Page(parentPage.x,
            ...
            height, this.currentLayer, this.layers.length);
        ...
        let bottomPage = new Page(parentPage.x,
            height + parentPage.y,
            parentPage.origWidth,
            remainingHeight, this.currentLayer, this.layers.length);
    ...
    sliceHorizontally(mousePos)
    {
        ...
        let leftPage = new Page(parentPage.x,
            parentPage.y,
            width,
            parentPage.origHeight, this.currentLayer, this.layers.length);
        ...
        this.layerCtr++;
        rightPage.PanelName = "Panel"+ this.layerCtr;
